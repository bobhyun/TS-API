...
From here, we will omit the `auth=` part of request URLs for brevity. Note that v0 (legacy) API always returns **absolute URLs** (`http://{host}/...`) in JSON responses — `image`, `videoSrc`, `src` and similar fields include the full scheme and host. (v1 returns relative URLs instead.)
```ruby
# Parameters
...
```jsx
[
  "http://192.168.0.100/download/2018-01-01T00.00.00.xls",   // Excel file download URL
  ...
  "data": [
    {
      ...
      "image": "http://192.168.0.100/storage/e/0/0/7/7673/object/7673911/7673911.4412659.1590386295819221.object._c1_t2_s392x504.jpg" # image address
    },
    {
      ...
      "image": "http://192.168.0.100/storage/e/0/0/7/7673/object/7673911/7673911.4412660.1590386294449281.object._c1_t2_s744x624.jpg" # image address
    },
    {
      ...
      "image": "http://192.168.0.100/storage/e/0/0/7/7673/object/7673911/7673911.4412658.1590386294185653.object._c1_t1_s296x464.jpg" # image address
    },
    {
      ...
      "image": "http://192.168.0.100/storage/e/0/0/7/7673/object/7673909/7673909.4412630.1590386121557955.object._c1_t3_s440x312.jpg" # image address
    },
    // ... omitted
  ]
}
...
```jsx
{
  ...
  "chid": {                                     // Car number recognition channel
    ...
    "title":"Camera1",
    "displayName":"CH1. Camera1", // Added since TS-API@0.9.4
    "src":"http://192.168.0.100/watch?ch=1&when=2018%2D06%2D27T10%3A42%3A06%2E575-05%3A00"  // The video at vehicle identification time
  },
  ...
  "linkedChannel": [                            // Linked channels
    {
      ...
      "src":"http://192.168.0.100/watch?ch=2&when=2018%2D06%2D27T10%3A42%3A06%2E575-05%3A00" // The video at vehicle identification time
    }
  ],
  "image":"http://192.168.0.100/storage/e/0/0/0/39/39612.161192.1576732638241699.plate.jpg", // captured still cut image
...
```jsx
{
  ...
  "image": "http://192.168.0.100/storage/e/0/0/7/7673/object/7673854/7673854.4411971.1590382562558672.object._c1_t2_s552x400.jpg" # image address
}
```
2. `face` attributes
    | key         | type     | list                                 |
...
```jsx
{
  ...
  "image": "http://192.168.0.100/storage/e/0/0/7/7673/object/7673854/7673854.4411974.1590382578461739.object._c1_t1_s376x600.jpg" # image address
}
```
2. `human` attributes
    | key         | type                | list                             |
...
1. Example data
{
  ...
  "image": "http://192.168.0.100/storage/e/0/0/7/7673/object/7673880/7673880.4412174.1590384238768802.object._c1_t3_s944x520.jpg" # image address
}
```
